...
describe('search-page-embedded', () => {
  ...
  it('should render successfully with query and im-url', () => {
    const widgetClient = getWidgetClient(widgetConfig, 'wigmix_search_page_embedded', 'VERSION', () => ({
      ...mockVisearchClient,
      ...
      <RootContext.Provider value={document.body}>
        <WidgetDataContext.Provider value={{ widgetConfig, widgetClient, darkMode: false, locale: 'en' }}>
          <IntlProvider messages={texts['en']} locale='en' defaultLocale='en'>
            <SearchPageEmbedded textQuery='testQuery' imUrl='test-im-url' />
          </IntlProvider>
  ...
  it('should render successfully with query', () => {
    ...
    testComponent = render(
      <RootContext.Provider value={document.body}>
        <WidgetDataContext.Provider value={{ widgetConfig, widgetClient, darkMode: false, locale: 'en' }}>
          <IntlProvider messages={texts['en']} locale='en' defaultLocale='en'>
            <SearchPageEmbedded textQuery='testQuery' imUrl='' />
          </IntlProvider>
        </WidgetDataContext.Provider>
      </RootContext.Provider>,
    );
  ...
  it('should render successfully with im-url', () => {
    ...
    testComponent = render(
      <RootContext.Provider value={document.body}>
        <WidgetDataContext.Provider value={{ widgetConfig, widgetClient, darkMode: false, locale: 'en' }}>
          <IntlProvider messages={texts['en']} locale='en' defaultLocale='en'>
            <SearchPageEmbedded textQuery='' imUrl='test-im-url' />
          </IntlProvider>
        </WidgetDataContext.Provider>
      </RootContext.Provider>,
    );
  ...
  it('should fail render with system error', () => {
    ...
    testComponent = render(
      <RootContext.Provider value={document.body}>
        <WidgetDataContext.Provider value={{ widgetConfig, widgetClient, darkMode: false, locale: 'en' }}>
          <IntlProvider messages={texts['en']} locale='en' defaultLocale='en'>
            <SearchPageEmbedded textQuery=' ' imUrl='' />
          </IntlProvider>
        </WidgetDataContext.Provider>
      </RootContext.Provider>,
    );
  ...
  it('should render with no results', () => {
    ...
    testComponent = render(
      <RootContext.Provider value={document.body}>
        <WidgetDataContext.Provider value={{ widgetConfig, widgetClient, darkMode: false, locale: 'en' }}>
          <IntlProvider messages={texts['en']} locale='en' defaultLocale='en'>
            <SearchPageEmbedded textQuery='no_result' imUrl='' />
          </IntlProvider>
        </WidgetDataContext.Provider>
      </RootContext.Provider>,
    );

...
export const DEFAULT_TEXTS: LanguagePack = {
  ...
  es: {
    ...
    outfitRecommendations: 'Recomendaciones de Conjuntos',
  ...
  fr: {
    ...
    outfitRecommendations: 'Recommandations de Tenues',
  ...
  pt: {
    ...
    outfitRecommendations: 'Recomendações de Looks',
  ...
  de: {
    ...
    outfitRecommendations: 'Outfit-Empfehlungen',
  ...
  it: {
    ...
    outfitRecommendations: 'Consigli di Outfit',
  ...
  pl: {
    ...
    outfitRecommendations: 'Propozycje Stylizacji',
  ...
  ja: {
    ...
    outfitRecommendations: 'コーディネートのおすすめ',
  ...
  th: {
    ...
    outfitRecommendations: 'แนะนำชุดแต่งกาย',

...
This is the repository for ViSenze's Shoppable Gallery widget. 
...
```
├─ shoppable-gallery        <- Folder containing the standalone code 
   ├─ components        <- Components used by the widget
├── shoppable-gallery.tsx    <- Main widget code.

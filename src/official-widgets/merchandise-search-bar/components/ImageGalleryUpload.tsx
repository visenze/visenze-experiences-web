    ...
    if (customizations) {
      return Object.entries(customizations.imageUpload?.images || []).map(([, imageWithLabel], index) => {
        ...
        return (
          ...
          >
            <img className='h-full w-fit object-cover' src={imageWithLabel.url} data-pw={`msb-gallery-image-${index + 1}`}/>
  ...
  return (
    <div className='relative flex'>
      <div className='flex items-center justify-center rounded-full bg-zinc-100 cursor-pointer size-10' onClick={onIconClickHandler}
           data-testid='wigmix-msb-gallery-button' data-pw='msb-gallery-button'>
        {searchImage && (
            <>
      ...
      <VisenzeModal open={openModal} onClose={onCloseHandler} layout={breakpoint} position='center'
        ...
        <div className='flex size-full flex-col'>
          <div className='relative flex w-full items-center justify-center py-4'>
            {/* Title */}
            <p className='wigmix-widget-title px-16 md:px-0 text-center' data-pw='msb-image-upload-title'>
            ...
            <div className='absolute right-5 top-3 rounded-full p-1 bg-transparent hover:opacity-90'
                 onClick={onCloseHandler} data-testid='wigmix-msb-close-button' data-pw='msb-close-button'>

...
const Header: FC<HeaderProps> = ({ onCloseHandler, showTitle, iconColor }): ReactElement => {
  ...
  return (
    <div className='relative flex w-full items-center py-4 ps-8 lg:rounded-t-3xl'>
      {showTitle && (
      ...
      <div className='absolute end-4 top-2 rounded-full bg-transparent p-1 hover:opacity-90 md:end-5 md:top-4'
